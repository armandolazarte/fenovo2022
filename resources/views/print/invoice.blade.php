...
@for ($pag = 0; $pag < $paginas; $pag++) <head>
  ...
  <body>
    ...
    <div style="overflow:hidden;">
        ...
        <tr>
          ...
          <td class="factura">
            <p style="margin: 0;padding:0"><span style="font-size:12px; ">C.U.I.T.:&nbsp;</span>
              ...
              <span style="font-size:12px;float: right; text-align:right"> 19/04/2006</span>
            </p>
          </td>
        </tr>
      </table>
      ...
      <table class="table-periodo">
        <tr>
          <td style="border-left: 1px solid #999797;border-bottom: 1px solid #999797;border-right: 1px solid #999797; width: 50%;">
