...
<ul class="nav nav-pills" id="pills-tab1" role="tablist">
    <li class="nav-item mr-2">
        <a class="nav-link btn-dark active shadow-none" id="valuados-tab-basic" data-toggle="pill" href="#valuados" role="tab" aria-controls="valuados" aria-selected="true">
            Stocks valuados
        </a>
    </li>
    <li class="nav-item mr-2" id="nav-item-precios">
        <a class="nav-link btn-dark shadow-none" id="sin-valuar-tab-basic" data-toggle="pill" href="#sin-valuar" role="tab" aria-controls="sin-valuar" aria-selected="false">
            Stocks
        </a>
    </li>
</ul>
...
<div class="tab-content" id="v-pills-tabContent1">
    <div class="tab-pane fade show active" id="valuados" role="tabpanel" aria-labelledby="home-tab-basic">        
        <div class="table-responsive">
            <table class=" table table-hover dataTable table-condensed yajra-datatable text-center" role="grid" id="tabla-valores">
                <thead>
    ...
    <div class="tab-pane fade" id="sin-valuar" role="tabpanel" aria-labelledby="service-tab-basic">
        <div class="table-responsive">
            <table class=" table table-hover dataTable table-condensed yajra-datatable text-center" role="grid" id="tabla-sin-valuar">
                <thead>
                    <tr class="bg-dark text-black-50">
                        <td>Codigo</td>
                        <td>Producto</td>
