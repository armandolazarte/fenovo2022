                                ...
                                <div class="card-header align-items-center  border-0">
                                    <div class="card-title mb-0">
                                        <h4 class="card-label mb-0 font-weight-bold text-body">
                                            Editar Producto - <small>{{ $product->cod_fenovo }} ::
                                                {{ $product->name }}</small>
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <ul class="nav nav-pills mb-3" id="pills-tab1" role="tablist">
                                        <li class="nav-item mr-2">
                                            <a class="nav-link btn-dark active shadow-none" id="precios-tab-basic"
                                                data-toggle="pill" href="#precios" role="tab" aria-controls="precios"
                                                aria-selected="true">
                                                Precios
                                            </a>
                                        </li>
                                        <li class="nav-item mr-2" id="nav-item-precios">
                                            <a class="nav-link btn-dark shadow-none" id="detalle-tab-basic"
                                                data-toggle="pill" href="#detalle" role="tab" aria-controls="detalle"
                                                aria-selected="false">
                                                Detalles
                                            </a>
                                        </li>
                                        <li class="nav-item mr-2" id="nav-item-imagenes">
                                            <a class="nav-link btn-dark shadow-none" id="imagenes-tab-basic"
                                                data-toggle="pill" href="#imagenes" role="tab" aria-controls="imagenes"
                                                aria-selected="false">
                                                Imágenes
                                            </a>
                                        </li>
                            ...
                            <div class="row">
                                <form method="POST" action="{{ route('product.update') }}" id="formData">
                                    ...
                                    @if (isset($product))
                                        ...
                                        <input type="hidden" name="fecha_actualizacion_activa"
                                            id="fecha_actualizacion_activa" value="{{ $fecha_actualizacion_activa }}">
                                        <input type="hidden" name="fecha_actualizacion_label"
                                            id="fecha_actualizacion_label" value="{{ $fecha_actualizacion_label }}">
                                    @else
                                    ...
                                    <div class="col-12">
                                        <div class="tab-content" id="v-pills-tabContent1">
                                            ...
                                            <div class="tab-pane fade" id="imagenes" role="tabpanel"
                                                aria-labelledby="account-tab-basic">
                                    ...
                                    @if (isset($product))
                                        <div class="col-12" style="float: right">
                                            <button type="button" id="btn_product" disabled class="btn btn-primary"
                                                onclick="updateProduct('{{ route('product.update') }}')"
                                                style="float: right"><i class="fa fa-save"></i> Guardar</button>
                                        </div>
                                    @endif
                                </form>
                            </div>
...
@section('js')
    ...
    <script>
        ...
        const eliminarActualizacion = (id) => {

            ymz.jq_confirm({
                title: 'Confirme',
                text: '<div class="text-center">Eliminará ésta actualización ?</div>',
                no_btn: "Cancelar",
                yes_btn: "Confirmar",
                no_fn: function() {
                    return false;
        ...
        const eliminarOferta = (id) => {
            ...
            ymz.jq_confirm({
                title: 'Confirme',
                text: '<div class="text-center">Eliminará ésta oferta ?</div>',
                no_btn: "Cancelar",
                yes_btn: "Confirmar",
                no_fn: function() {
                    return false;
