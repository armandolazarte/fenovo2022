    ...
    <div class="col-md-6">
        <div class="form-group row">
            <div class="col-md-12">
                ...
                <fieldset class="form-group mb-3">
                    <input type="text" name="name" id="name"
                        @if (isset($product)) value="{{ $product->name }}" @else value="" @endif
                ...
                <fieldset class="form-group mb-3">
                    <select class="js-example-basic-single js-states form-control bg-transparent" name="categorie_id"
                        ...
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}" @if (isset($product) && $product->categorie_id == $category->id) selected @endif>
            ...
            <div class="col-md-4">
                ...
                <fieldset class="form-group mb-3">
                    <input type="number" name="cod_fenovo" id="cod_fenovo"
                        @if (isset($product)) value="{{ $product->cod_fenovo }}" @else value="" @endif
                        class="form-control border-dark" onfocusout="validateCode()">
                </fieldset>
            </div>
            <div class="col-md-2">
                <label class="text-body">Palet</label>
                <fieldset class="form-group mb-3">
                    <select class="form-control bg-transparent" name="palet" id="palet">
                        <option value="">Seleccione palet</option>
                        <option value="A" @if (isset($product) && $product->palet == 'A') selected @endif>A</option>
                        <option value="B" @if (isset($product) && $product->palet == 'B') selected @endif>B</option>
                    </select>
                </fieldset>
            </div>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="text" class="form-control border-dark"
                        @if (isset($product)) value="{{ $product->barcode }}" @else value="" @endif
            ...
            <div class="col-md-12 mb-3">
                ...
                <textarea type="text" name="description" rows="4" id="txtarea" class="autoexpand-textarea form-control"
                    @if (isset($product)) value="{{ $product->description }}" @else value="" @endif>
@if (isset($product))
{{ $product->description }}
@endif
</textarea>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="text" class="form-control border-dark"
                        @if (isset($product)) value="{{ $product->cod_cuenta_compra }}" @else value="" @endif
                        name="cod_cuenta_compra" id="cod_cuenta_compra">
                </fieldset>
            </div>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="text" class="form-control border-dark"
                        @if (isset($product)) value="{{ $product->cod_cuenta_venta }}" @else value="" @endif
                        name="cod_cuenta_venta" id="cod_cuenta_venta">
                </fieldset>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group row">
                ...
                <fieldset class="form-group mb-3">
                    <select class="js-example-basic-single js-states form-control bg-transparent" name="proveedor_id"
                        ...
                        @foreach ($proveedores as $proveedor)
                            <option value="{{ $proveedor->id }}" @if (isset($product) && $product->proveedor_id == $proveedor->id) selected @endif>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="text" class="form-control border-dark"
                        @if (isset($product)) value="{{ $product->cod_proveedor }}" @else value="" @endif
                        name="cod_proveedor" id="cod_proveedor">
                </fieldset>
            </div>
            ...
            <div class="col-md-4">
                ...
                <fieldset class="form-group mb-3">
                    <select class="js-example-basic-single js-states form-control bg-transparent"
                        name="unit_package[]" id="unit_package" multiple="multiple">
            ...
            <div class="col-md-3">
                ...
                <fieldset class="form-group mb-3">
                    <input type="number" class="form-control border-dark"
                        @if (isset($product)) value="{{ $product->stock_sem_min }}" @else value="2" @endif
                        name="stock_sem_min" id="stock_sem_min">
                </fieldset>
            </div>
            ...
            <div class="col-md-3">
                ...
                <fieldset class="form-group mb-3">
                    <input type="number" class="form-control border-dark"
                        @if (isset($product)) value="{{ $product->stock_sem_max }}" @else value="2" @endif
                        name="stock_sem_max" id="stock_sem_max">
                </fieldset>
            </div>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="number" class="form-control border-dark"
                        @if (isset($product)) value="{{ $product->stock_min }}" @else value="100" @endif
                        name="stock_min" id="stock_min">
                </fieldset>
            </div>
            ...
            <div class="col-md-4">
                ...
                <fieldset class="input-group form-group mb-3">
                    <input type="number" class="form-control border-dark" name="hight" id="hight"
                        @if (isset($product)) value="{{ $product->hight }}" @else value="" @endif>
                    <div class="input-group-prepend">
            ...
            <div class="col-md-4">
                ...
                <fieldset class="input-group form-group mb-3">
                    <input type="number" class="form-control border-dark" name="width" id="width"
                        @if (isset($product)) value="{{ $product->width }}" @else value="" @endif>
                    <div class="input-group-prepend">
                        <span class="input-group-text">mt.</span>
                    </div>
                </fieldset>
            ...
            <div class="col-md-4">
                ...
                <fieldset class="input-group form-group mb-3">
                    <input type="number" class="form-control border-dark" name="long" id="long"
                        @if (isset($product)) value="{{ $product->long }}" @else value="" @endif>
                    <div class="input-group-prepend">
                        <span class="input-group-text">mt.</span>
                    </div>
                </fieldset>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="number" class="form-control border-dark" name="package_palet" id="package_palet"
                        @if (isset($product)) value="{{ $product->package_palet }}" @else value="0" @endif>
                </fieldset>
            </div>
            ...
            <div class="col-md-6">
                ...
                <fieldset class="form-group mb-3">
                    <input type="number" class="form-control border-dark" name="package_row"
                        @if (isset($product)) value="{{ $product->package_row }}" @else value="0" @endif>
                </fieldset>
            </div>
            ...
            <div class="col-md-3">
                ...
                <fieldset class="form-group mb-3">
                    <select class="js-example-basic-single js-states form-control bg-transparent" name="currency"
                        id="currency">
                        <option value="$" @if (isset($product) && $product->currency == '$') selected @endif>Peso Argentino
                        </option>
    ...
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-md-1">
                ...
                <div class="custom-control switch custom-switch custom-control-inline">
                    <input type="checkbox" class="custom-control-input" id="online_sale" name="online_sale"
                        @if (isset($product) && $product->online_sale) checked="" @elseif(isset($product) && !$product->online_sale) unchecked="" @else checked="" @endif
                        value="1">
            ...
            <div class="col-md-1">
                <p>IIBB :</p>
                <div class="custom-control switch custom-switch custom-control-inline">
                    <input type="checkbox" class="custom-control-input" id="iibb" name="iibb"
                        @if (isset($product) && $product->iibb) checked="" @elseif(isset($product) && !$product->iibb)) unchecked="" @else checked="" @endif
                        value="1">
            ...
            <div class="col-md-1">
                ...
                <div class="custom-control switch custom-switch custom-control-inline">
                    <input type="checkbox" class="custom-control-input" id="active" name="active"
                        @if (isset($product) && $product->active) checked="" @elseif(isset($product) && !$product->active)) unchecked="" @else checked="" @endif
                        value="1">
