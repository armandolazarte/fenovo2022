            ...
            <tbody>
                ...
                @foreach ($movimientos as $movimiento)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#"
                                onclick="borrarDetalleCheck('{{ $movimiento->movement_id }}', '{{ $movimiento->product_id }}')">
    ...
    <div class="row">
        <div class="col-7">
            <table class="table table-bordered text-left">
                <tr>
                    <td>Ley25413</td>
                    <th><input type="text" min="0" step="0.1" value="{{ ($comprobante)?$comprobante->l25413:0 }}" name="l25413" id="l25413" onkeyup="totalizar()"
                            class=" form-control text-center border-info calculateCompra"></th>
                    <td>Ret.ATER</td>
                    <th><input type="text" min="0" step="0.1" value="{{ ($comprobante)?$comprobante->retater:0 }}" name="retater" id="retater" onkeyup="totalizar()"
                            class=" form-control text-center border-info calculateCompra"></th>
                    <td>Ret.IVA</td>
                    <th><input type="text" min="0" step="0.1" value="{{ ($comprobante)?$comprobante->retiva:0 }}" name="retiva" id="retiva" onkeyup="totalizar()"
                            class=" form-control text-center border-info calculateCompra"></th>
                    <td>Ret.GAN</td>
                    <th><input type="text" min="0" step="0.1" value="{{ ($comprobante)?$comprobante->retgan:0 }}" name="retgan" id="retgan" onkeyup="totalizar()"
                            class=" form-control text-center border-info calculateCompra"></th>
                </tr>
                <tr>
                    <td>No Grav.</td>
                    <th><input type="text" min="0" step="0.1" value="{{ ($comprobante)?$comprobante->nograv:0 }}" name="nograv" id="nograv" onkeyup="totalizar()"
                            class=" form-control text-center border-info calculateCompra"></th>
                    <td>Perc.ATER</td>
                    <th><input type="text" min="0" step="0.1" value="{{ ($comprobante)?$comprobante->percater:0 }}" name="percater" id="percater" onkeyup="totalizar()"
                            class=" form-control text-center border-info calculateCompra"></th>
                    <td>Perc.IVA</td>
                    <th><input type="text" min="0" step="0.1" value="{{ ($comprobante)?$comprobante->perciva:0 }}" name="perciva" id="perciva" onkeyup="totalizar()"
                            class=" form-control text-center border-info calculateCompra"></th>
                    <td>Exento</td>
                    <th><input type="text" min="0" step="0.1" value="{{ ($comprobante)?$comprobante->exento:0 }}" name="exento" id="exento" onkeyup="totalizar()"
                            class=" form-control text-center border-info calculateCompra"></th>
                </tr>
            </table>
