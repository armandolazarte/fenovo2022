    ...
    <div class="container-fluid all-show">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                ...
                @can('pedidos.index')
                    <li class="nav-item"
                        title="Lista de pedidos - @if ($nroPedidos > 0) tiene {{ $nroPedidos }} pedido pendientes @endif ">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item mt-2" title="Opciones del usuario">
                    <a href="{{ route('users.editProfile') }}" class="nav-link">
                        {{ ucfirst(Auth::user()->username) }} <small> [ {{ Auth::user()->rol() }} ] </small>
                    </a>
                </li>
