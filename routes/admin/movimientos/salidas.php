...
Route::get('actualizar-stock/{code?}/{store_id?}', [SalidasController::class, 'updateStock'])->name('update.stock');
Route::get('actualizar-stock-stores/{store_id?}/{code?}', [SalidasController::class, 'updateStockStores'])->name('update.stock.stores');
